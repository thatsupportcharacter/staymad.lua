print("-> Initializing StayMad Live...")
print("-> ...")
print("-> ..")
print("-> .")
print(" _____________________________________")
print("| StayMad Live Build Loaded          |")
print("| Version: 1.3                        |")
print("| Dev: tony.-#0010                    |")
print("|_____________________________________|")
...
local ui = {
    -- main
    welcome = menu.add_text("StayMad | Information", "You are now a god with StayMad.lua!"),
    buildstate = menu.add_text("StayMad | Information", string.format("Build State: %s", build)),
    selection_item = menu.add_selection("StayMad | Information", "Current Tab:", {"Ragebot","Anti-aims dont press", "Visuals", "Misc"}),

    FasterDoubletap = menu.add_checkbox("StayMad | Ragebot", "Faster Doubletap", false),
    ClockCorrection = menu.add_checkbox("StayMad | Ragebot", "Disable Clock Correction", false),
    saferecharge    = menu.add_checkbox("StayMad | Ragebot", "Safe Recharge", false),
    AET             = menu.add_checkbox("StayMad | Ragebot", "Quick Fall (Awp and Scout)", false),
    customfakeping  = menu.add_checkbox("StayMad | Ragebot", "Custom backtrack", false),
    fpamount  = menu.add_slider("StayMad | Ragebot", "Custom backtrack amount", 0, 1000),

    selection_presets = menu.add_selection("staymad | Anti-aims", "Anti-aim preset:", {"-","Avoidance Jitter", "Tank AA", "Safe head", "Conditional"}),
    selection_condition = menu.add_selection("staymad | Anti-aims", "Player state:", {"Standing", "Moving", "Slowwalk", "Crouch", "Air"}),
	-- Anti-aims
    Sseperator = menu.add_text("staymad | Anti-aims Standing", "|   Yaw Base   |"),
    Spitch = menu.add_selection("staymad | Anti-aims Standing", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Syawmode = menu.add_selection("staymad | Anti-aims Standing", "Yaw mode", {"Static", "Jitter"}),
    Syawadd = menu.add_slider("staymad | Anti-aims Standing", "Yaw add", -180, 180),
    Syawaddleft = menu.add_slider("staymad | Anti-aims Standing", "Yaw jitter left", -180, 180),
    Syawaddright = menu.add_slider("staymad | Anti-aims Standing", "Yaw jitter right", -180, 180),
    Saw_base = menu.add_selection("staymad | Anti-aims Standing", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Sseperator3 = menu.add_text("staymad | Anti-aims Standing", "| Yaw Modifier |"),
    Srotate = menu.add_checkbox("staymad | Anti-aims Standing", "Rotate", false),
    Srotaterange = menu.add_slider("staymad | Anti-aims Standing", "Rotate Range", 0, 360),
    Srotatespeed = menu.add_slider("staymad | Anti-aims Standing", "Rotate Speed", 0, 100),
    Sjittermode = menu.add_selection("staymad | Anti-aims Standing", "Jitter Mode:", {"None", "Static", "Random"}),
    Sjittertype = menu.add_selection("staymad | Anti-aims Standing", "Jitter Type:", {"Offset", "Center"}),
    Sjitteradd = menu.add_slider("staymad | Anti-aims Standing", "Jitter Amount", -180, 180),
    Sseperator5 = menu.add_text("staymad | Anti-aims Standing", "| Roll Angles |"),
    Sbodyleanmode = menu.add_selection("staymad | Anti-aims Standing", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Sbodyleanamount = menu.add_slider("staymad | Anti-aims Standing", "Body Lean Amount:", -50, 50),
    Sbodyleanjitter = menu.add_slider("staymad | Anti-aims Standing", "Body Lean Jitter:", 0, 100),
    Sseperator7 = menu.add_text("staymad | Anti-aims Standing", "| Fake  Options |"),
    SD_side = menu.add_selection("staymad | Anti-aims Standing", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Sfake_limit_left = menu.add_slider("staymad | Anti-aims Standing", "Fake limit left", 0, 100),
    Sfake_limit_right = menu.add_slider("staymad | Anti-aims Standing", "Fake limit right", 0, 100),
    SAntibrute = menu.add_checkbox("staymad | Anti-aims Standing", "Anti-Bruteforce", false),
    SOn_shot = menu.add_selection("staymad | Anti-aims Standing", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Sseperator9 = menu.add_text("staymad | Anti-aims Standing", "| Fake lag |"),
    Sfakelag_limit = menu.add_slider("staymad | Anti-aims Standing", "Fake Lag Amount", 1, 15),

    Mseperator = menu.add_text("staymad | Anti-aims Moving", "|   Yaw Base   |"),
    Mpitch = menu.add_selection("staymad | Anti-aims Moving", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Myawmode = menu.add_selection("staymad | Anti-aims Moving", "Yaw mode", {"Static", "Jitter"}),
    Myawadd = menu.add_slider("staymad | Anti-aims Moving", "Yaw add", -180, 180),
    Myawaddleft = menu.add_slider("staymad | Anti-aims Moving", "Yaw jitter left", -180, 180),
    Myawaddright = menu.add_slider("staymad | Anti-aims Moving", "Yaw jitter right", -180, 180),
    Maw_base = menu.add_selection("staymad | Anti-aims Moving", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Mseperator3 = menu.add_text("staymad | Anti-aims Moving", "| Yaw Modifier |"),
    Mrotate = menu.add_checkbox("staymad | Anti-aims Moving", "Rotate", false),
    Mrotaterange = menu.add_slider("staymad | Anti-aims Moving", "Rotate Range", 0, 360),
    Mrotatespeed = menu.add_slider("staymad | Anti-aims Moving", "Rotate Speed", 0, 100),
    Mjittermode = menu.add_selection("staymad | Anti-aims Moving", "Jitter Mode:", {"None", "Static", "Random"}),
    Mjittertype = menu.add_selection("staymad | Anti-aims Moving", "Jitter Type:", {"Offset", "Center"}),
    Mjitteradd = menu.add_slider("staymad | Anti-aims Moving", "Jitter Amount", -180, 180),
    Mseperator5 = menu.add_text("staymad | Anti-aims Moving", "| Roll Angles |"),
    Mbodyleanmode = menu.add_selection("staymad | Anti-aims Moving", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Mbodyleanamount = menu.add_slider("staymad | Anti-aims Moving", "Body Lean Amount:", -50, 50),
    Mbodyleanjitter = menu.add_slider("staymad | Anti-aims Moving", "Body Lean Jitter:", 0, 100),
    MAseperator7 = menu.add_text("staymad | Anti-aims Moving", "| Fake  Options |"),
    MD_side = menu.add_selection("StayMad | Anti-aims Moving", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Mfake_limit_left = menu.add_slider("staymad | Anti-aims Moving", "Fake limit left", 0, 100),
    Mfake_limit_right = menu.add_slider("staymad | Anti-aims Moving", "Fake limit right", 0, 100),
    MAntibrute = menu.add_checkbox("staymad | Anti-aims Moving", "Anti-Bruteforce", false),
    MOn_shot = menu.add_selection("staymad | Anti-aims Moving", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Mseperator9 = menu.add_text("staymad | Anti-aims Moving", "| Fake lag |"),
    Mfakelag_limit = menu.add_slider("staymad | Anti-aims Moving", "Fake Lag Amount", 1, 15),
   
    SLseperator = menu.add_text("StayMad | Anti-aims Slowwalk", "|   Yaw Base   |"),
    SLpitch = menu.add_selection("StayMad | Anti-aims Slowwalk", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    SLyawmode = menu.add_selection("StayMad | Anti-aims Slowwalk", "Yaw mode", {"Static", "Jitter"}),
    SLyawadd = menu.add_slider("StayMad | Anti-aims Slowwalk", "Yaw add", -180, 180),
    SLyawaddleft = menu.add_slider("StayMad | Anti-aims Slowwalk", "Yaw jitter left", -180, 180),
    SLyawaddright = menu.add_slider("StayMad | Anti-aims Slowwalk", "Yaw jitter right", -180, 180),
    SLaw_base = menu.add_selection("StayMad | Anti-aims Slowwalk", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    SLseperator3 = menu.add_text("StayMad | Anti-aims Slowwalk", "| Yaw Modifier |"),
    SLrotate = menu.add_checkbox("StayMad | Anti-aims Slowwalk", "Rotate", false),
    SLrotaterange = menu.add_slider("StayMad | Anti-aims Slowwalk", "Rotate Range", 0, 360),
    SLrotatespeed = menu.add_slider("StayMad | Anti-aims Slowwalk", "Rotate Speed", 0, 100),
    SLjittermode = menu.add_selection("StayMad | Anti-aims Slowwalk", "Jitter Mode:", {"None", "Static", "Random"}),
    SLjittertype = menu.add_selection("StayMad | Anti-aims Slowwalk", "Jitter Type:", {"Offset", "Center"}),
    SLjitteradd = menu.add_slider("StayMad | Anti-aims Slowwalk", "Jitter Amount", -180, 180),
    SLseperator5 = menu.add_text("StayMad | Anti-aims Slowwalk", "| Roll Angles |"),
    SLbodyleanmode = menu.add_selection("StayMad | Anti-aims Slowwalk", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    SLbodyleanamount = menu.add_slider("StayMad | Anti-aims Slowwalk", "Body Lean Amount:", -50, 50),
    SLbodyleanjitter = menu.add_slider("StayMad | Anti-aims Slowwalk", "Body Lean Jitter:", 0, 100),
    SLseperator7 = menu.add_text("StayMad | Anti-aims Slowwalk", "| Fake  Options |"),
    SLD_side = menu.add_selection("StayMad | Anti-aims Slowwalk", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    SLfake_limit_left = menu.add_slider("StayMad | Anti-aims Slowwalk", "Fake limit left", 0, 100),
    SLfake_limit_right = menu.add_slider("StayMad | Anti-aims Slowwalk", "Fake limit right", 0, 100),
    SLAntibrute = menu.add_checkbox("StayMad | Anti-aims Slowwalk", "Anti-Bruteforce", false),
    SLOn_shot = menu.add_selection("StayMad | Anti-aims Slowwalk", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    SLseperator9 = menu.add_text("StayMad | Anti-aims Slowwalk", "| Fake lag |"),
    SLfakelag_limit = menu.add_slider("StayMad | Anti-aims Slowwalk", "Fake Lag Amount", 1, 15),

    Cseperator = menu.add_text("StayMad | Anti-aims Crouch", "|   Yaw Base   |"),
    Cpitch = menu.add_selection("StayMad | Anti-aims Crouch", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Cyawmode = menu.add_selection("StayMad | Anti-aims Crouch", "Yaw mode", {"Static", "Jitter"}),
    Cyawadd = menu.add_slider("StayMad | Anti-aims Crouch", "Yaw add", -180, 180),
    Cyawaddleft = menu.add_slider("StayMad | Anti-aims Crouch", "Yaw jitter left", -180, 180),
    Cyawaddright = menu.add_slider("StayMad | Anti-aims Crouch", "Yaw jitter right", -180, 180),
    Caw_base = menu.add_selection("StayMad | Anti-aims Crouch", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Cseperator3 = menu.add_text("StayMad | Anti-aims Crouch", "| Yaw Modifier |"),
    Crotate = menu.add_checkbox("StayMad | Anti-aims Crouch", "Rotate", false),
    Crotaterange = menu.add_slider("StayMad | Anti-aims Crouch", "Rotate Range", 0, 360),
    Crotatespeed = menu.add_slider("StayMad | Anti-aims Crouch", "Rotate Speed", 0, 100),
    Cjittermode = menu.add_selection("StayMad | Anti-aims Crouch", "Jitter Mode:", {"None", "Static", "Random"}),
    Cjittertype = menu.add_selection("StayMad | Anti-aims Crouch", "Jitter Type:", {"Offset", "Center"}),
    Cjitteradd = menu.add_slider("StayMad | Anti-aims Crouch", "Jitter Amount", -180, 180),
    Cseperator5 = menu.add_text("StayMad | Anti-aims Crouch", "| Roll Angles |"),
    Cbodyleanmode = menu.add_selection("StayMad | Anti-aims Crouch", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Cbodyleanamount = menu.add_slider("StayMad | Anti-aims Crouch", "Body Lean Amount:", -50, 50),
    Cbodyleanjitter = menu.add_slider("StayMad | Anti-aims Crouch", "Body Lean Jitter:", 0, 100),
    Cseperator7 = menu.add_text("StayMad | Anti-aims Crouch", "| Fake  Options |"),
    CD_side = menu.add_selection("StayMad | Anti-aims Crouch", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Cfake_limit_left = menu.add_slider("StayMad | Anti-aims Crouch", "Fake limit left", 0, 100),
    Cfake_limit_right = menu.add_slider("StayMad | Anti-aims Crouch", "Fake limit right", 0, 100),
    CAntibrute = menu.add_checkbox("StayMad | Anti-aims Crouch", "Anti-Bruteforce", false),
    COn_shot = menu.add_selection("StayMad | Anti-aims Crouch", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Cseperator9 = menu.add_text("StayMad | Anti-aims Crouch", "| Fake lag |"),
    Cfakelag_limit = menu.add_slider("StayMad | Anti-aims Crouch", "Fake Lag Amount", 1, 15),
       
    Aseperator = menu.add_text("StayMad | Anti-aims Air", "|   Yaw Base   |"),
    Apitch = menu.add_selection("StayMad | Anti-aims Air", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Ayawmode = menu.add_selection("StayMad | Anti-aims Air", "Yaw mode", {"Static", "Jitter"}),
    Ayawadd = menu.add_slider("StayMad | Anti-aims Air", "Yaw add", -180, 180),
    Ayawaddleft = menu.add_slider("StayMad | Anti-aims Air", "Yaw jitter left", -180, 180),
    Ayawaddright = menu.add_slider("StayMad | Anti-aims Air", "Yaw jitter right", -180, 180),
    Aaw_base = menu.add_selection("StayMad | Anti-aims Air", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Aseperator3 = menu.add_text("StayMad | Anti-aims Air", "| Yaw Modifier |"),
    Arotate = menu.add_checkbox("StayMad | Anti-aims Air", "Rotate", false),
    Arotaterange = menu.add_slider("StayMad | Anti-aims Air", "Rotate Range", 0, 360),
    Arotatespeed = menu.add_slider("StayMad | Anti-aims Air", "Rotate Speed", 0, 100),
    Ajittermode = menu.add_selection("StayMad | Anti-aims Air", "Jitter Mode:", {"None", "Static", "Random"}),
    Ajittertype = menu.add_selection("StayMad | Anti-aims Air", "Jitter Type:", {"Offset", "Center"}),
    Ajitteradd = menu.add_slider("StayMad | Anti-aims Air", "Jitter Amount", -180, 180),
    Aseperator5 = menu.add_text("StayMad | Anti-aims Air", "| Roll Angles |"),
    Abodyleanmode = menu.add_selection("StayMad | Anti-aims Air", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Abodyleanamount = menu.add_slider("StayMad | Anti-aims Air", "Body Lean Amount:", -50, 50),
    Abodyleanjitter = menu.add_slider("StayMad | Anti-aims Air", "Body Lean Jitter:", 0, 100),
    Aseperator7 = menu.add_text("StayMad | Anti-aims Air", "| Fake  Options |"),
    AD_side = menu.add_selection("StayMad | Anti-aims Air", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Afake_limit_left = menu.add_slider("StayMad | Anti-aims Air", "Fake limit left", 0, 100),
    Afake_limit_right = menu.add_slider("StayMad | Anti-aims Air", "Fake limit right", 0, 100),
    AAntibrute = menu.add_checkbox("StayMad | Anti-aims Air", "Anti-Bruteforce", false),
    AOn_shot = menu.add_selection("StayMad | Anti-aims Air", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Aseperator9 = menu.add_text("StayMad | Anti-aims Air", "| Fake lag |"),
    Afakelag_limit = menu.add_slider("StayMad | Anti-aims Air", "Fake Lag Amount", 1, 15),

    --visuals

    Colortxt = menu.add_text("StayMad | Visuals", "Main color"),
    manualarrows = menu.add_selection("StayMad | Visuals", "Manual Arrows", {"-", "Modern", "Classic"}),
    indicatorsmain = menu.add_selection("StayMad | Visuals", "Indicators:", {"-", "Modern", "Classic", "Acatel"}),
    StayMadUI = menu.add_multi_selection("StayMad | Visuals", "StayMad UI", {"Watermark", "Keybinds", "Spectators", "State Panel"}),
    kibitmarker = menu.add_checkbox("StayMad | Visuals", "Kibit Marker", on_paint),

    --misc
    clientside_animations = menu.add_multi_selection("StayMad | Misc", "Clientside animations", {"Reversed legs", "Static legs in air", "Lean in-air", "Pitch 0 on land"}),
    clantag = menu.add_checkbox("StayMad | Misc", "Clantag"),
    killsay = menu.add_checkbox("StayMad | Misc", "Killsay"),
}
...
local lua_offsets = {
    keybind = {
        x = menu.add_slider("StayMad | Hidden", "keybind.x", 10, screensize.x),
        y = menu.add_slider("StayMad | Hidden", "keybind.y", 0, screensize.y),
        modes = {"[toggled]", "[hold]", "[on]", "[on]","[off]"},
        alpha = 0,
        size = 160,
    },
    spectator = {
        x = menu.add_slider("StayMad | Hidden", "spectators_x", 10, screensize.x),
        y = menu.add_slider("StayMad | Hidden", "spectators_y", 0, screensize.y),
        alpha = 0,
        list = {},
        size = 140,
    },
    panel = {
        x = menu.add_slider("StayMad | Hidden", "panels_x", 10, screensize.x),
        y = menu.add_slider("StayMad | Hidden", "panels_y", 0, screensize.y),
        alpha = 0,
        size = 140,
    },
}
...
menu.add_text("StayMad | Information","")
menu.add_text("StayMad | Information","")
menu.add_button("StayMad | Information", "Load Default Config", function()
...
---- visuals
    ...
    ui.StayMadUI:set(1, true)
    ui.StayMadUI:set(2, true)
    ui.StayMadUI:set(3, true)
    ui.StayMadUI:set(4, true)
...
local function Visuals_indic()
    ...
    if ui.indicatorsmain:get() == 2 and local_player:is_alive() then
        ...
        local eternal_ts = render.get_text_size(pixel, "StayMad")
        render.text(pixel, "StayMad", vec2_t(x + offset_scope + 18, y+ay-15), color_t(color_acc:get().r, color_acc:get().g, color_acc:get().b, 255), true, true)
        render.text(pixel, "Yaw", vec2_t(x + offset_scope + 45, y+ay-15), color_t(255, 255, 255, 255), true, true)
        render.text(pixel, "GOD", vec2_t(x+offset_scope+25, y+ay-25),color_t(255, 255, 255, alpha), false, true)
        ay = ay + 10
    ...
    if ui.indicatorsmain:get() == 3 and local_player:is_alive() then
        ...
        local eternal_ts = render.get_text_size(pixel, "StayMad")
        render.text(pixel, "StayMad", vec2_t(x + 13 + offset_scope, y+ay-25), color_t(255, 255, 255, 255), true, true)
...
local function getweapon()
    ...
    render.text(pixel, "StayMad", vec2_t(x/2+5, y/2+ay-25), color_t(255, 255, 255, 255), 10, true)
...
local function watermark()
    ...
    if not ui.StayMadUI:get(1) then return end
    local screensize = render.get_screen_size()
    local h, m, s = client.get_local_time()
    local color =  color_acc:get()
    local text1 = string.format("StayMad [%s] /", build)
    ...
    local wtm_string = string.format("StayMad [%s] / [%s] %s / %02d:%02d:%02d time / delay: %dms ", build, cheatusername, cheatuseruid, h, m, s, engine.get_latency(e_latency_flows)*1000)
...
local function keybinds()
    local color = color_acc()
    if not ui.StayMadUI:get(2) or not entity_list.get_local_player() then return end
...
local function spectators()
    ...
    local color = color_acc()
    if not ui.StayMadUI:get(3) or not entity_list.get_local_player() then return end
    local mousepos = input.get_mouse_pos()
...
local function panel()
    local color = color_acc()
    if not ui.StayMadUI:get(4) or not entity_list.get_local_player() then return end
    local mousepos = input.get_mouse_pos()
    ...
    render.text(verdana, "» StayMad-Get Good", vec2_t(lua_offsets.panel.x:get()+lua_offsets.panel.size/1.7, lua_offsets.panel.y:get()+16.5), color_t(255,255,255,255), true)
...
local function on_antiaim(ctx)
   ...
   cfg_import = menu.add_button("StayMad | Anti-aims", "Import Config From Clipboard", function() configs.import() end)
   cfg_export = menu.add_button("StayMad | Anti-aims", "Export Config To Clipboard", function() configs.export() end)
...
local function draw_menu()
    if not show then
      --  text_input_item:set_visible(false)
        menu.set_group_visibility("StayMad | Information", true)
        ...
        antia = false
        menu.set_group_column("StayMad | Information", 2)
        ...
        if menu_val == 2 then
            ...
            if selection_presets == 5 then
                ...
                if  menu_conditiom == 1 then
                    menu.set_group_column("StayMad | Anti-aims Standing", 1)
                    menu.set_group_visibility("StayMad | Anti-aims Standing", true)
                    menu.set_group_visibility("StayMad | Anti-aims Moving", false)
                    menu.set_group_visibility("StayMad | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("StayMad | Anti-aims Crouch", false)
                    menu.set_group_visibility("StayMad | Anti-aims Air", false)

                   
                elseif  menu_conditiom == 2 then
                    menu.set_group_column("StayMad | Anti-aims Moving", 1)
                    menu.set_group_visibility("StayMad | Anti-aims Standing", false)
                    menu.set_group_visibility("StayMad | Anti-aims Moving", true)
                    menu.set_group_visibility("StayMad | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("StayMad | Anti-aims Crouch", false)
                    menu.set_group_visibility("StayMad | Anti-aims Air", false)
                ...
                elseif  menu_conditiom == 3 then
                    menu.set_group_column("StayMad | Anti-aims Slowwalk", 1)
                    menu.set_group_visibility("StayMad | Anti-aims Standing", false)
                    menu.set_group_visibility("StayMad | Anti-aims Moving", false)
                    menu.set_group_visibility("StayMad | Anti-aims Slowwalk", true)
                    menu.set_group_visibility("StayMad | Anti-aims Crouch", false)
                    menu.set_group_visibility("StayMad | Anti-aims Air", false)

                   
                elseif  menu_conditiom == 4 then
                    menu.set_group_column("StayMad | Anti-aims Crouch", 1)
                    menu.set_group_visibility("StayMad | Anti-aims Standing", false)
                    menu.set_group_visibility("StayMad | Anti-aims Moving", false)
                    menu.set_group_visibility("StayMad | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("StayMad | Anti-aims Crouch", true)
                    menu.set_group_visibility("StayMad | Anti-aims Air", false)

                   
                elseif  menu_conditiom == 5 then
                    menu.set_group_column("StayMad | Anti-aims Air", 1)
                    menu.set_group_visibility("StayMad | Anti-aims Standing", false)
                    menu.set_group_visibility("StayMad | Anti-aims Moving", false)
                    menu.set_group_visibility("StayMad | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("StayMad | Anti-aims Crouch", false)
                    menu.set_group_visibility("StayMad | Anti-aims Air", true)
          ...
          menu.set_group_visibility("StayMad | Anti-aims", true)
          menu.set_group_visibility("StayMad | Visuals", false)
          menu.set_group_visibility("StayMad | Misc", false)
          menu.set_group_visibility("StayMad | Hidden", false)
          menu.set_group_column("StayMad | Anti-aims", 2)
        ...
        elseif menu_val == 3 then
            ...
            menu.set_group_visibility("StayMad | Anti-aims", false)
            menu.set_group_visibility("StayMad | Visuals", true)
            menu.set_group_visibility("StayMad | Misc", false)
            menu.set_group_visibility("StayMad | Ragebot", false)
            menu.set_group_visibility("StayMad | Hidden", false)
            menu.set_group_column("StayMad | Visuals", 1)
        ...
        elseif menu_val == 4 then
            ...
            menu.set_group_visibility("StayMad | Anti-aims", false)
            menu.set_group_visibility("StayMad | Visuals", false)
            menu.set_group_visibility("StayMad | Misc", true)
            menu.set_group_visibility("StayMad | Ragebot", false)
            menu.set_group_visibility("StayMad | Hidden", false)
            menu.set_group_column("StayMad | Misc", 1)
        ...
        elseif menu_val == 1 then
            ...
            menu.set_group_visibility("StayMad | Visuals", false)
            menu.set_group_visibility("StayMad | Misc", false)
            menu.set_group_visibility("StayMad | Ragebot", true)
            menu.set_group_visibility("StayMad | Hidden", false)
            menu.set_group_column("StayMad | Ragebot", 1)
        end
    else
    ...
    --  text_eu:set_visible(false)
      ...
      menu.set_group_visibility("StayMad | Ragebot", false)
      menu.set_group_visibility("StayMad | Anti-aims", false)
      menu.set_group_visibility("StayMad | Information", false)
      menu.set_group_visibility("StayMad | Visuals", false)
      menu.set_group_visibility("StayMad | Misc", false)
  end
end
  ...
  if menu.is_open() then
    ...
    local function math_clamp(val, low, high)
     ...
     color = color_acc()
      ...
      render.text(font,"Welcome " .. user.name .. " [" .. user.uid .. "] | StayMad | Build: ".. build .. " | Build Version: beta | Latest Update:  9/4/2022", pos + vec2_t(200,-25), color_t(255,255,255,255), 15, true)
 end
end
...
local get_phrase = function()
    local phrases = {"Tired of being a bottom? Get StayMad.lua and become a top!", "hoes mad as always", "Pwned by nn", "Tired of being an nn? Get StayMad.lua! You will still be an nn but cooler.", "talk shit get dropped"}
