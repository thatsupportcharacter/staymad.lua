...
local function panel()
    ...
    render.text(verdana, "» StayMad anti-aim technology", vec2_t(lua_offsets.panel.x:get()+lua_offsets.panel.size/1.7, lua_offsets.panel.y:get()+16.5), color_t(255,255,255,255), true)
...
local get_phrase = function()
    local phrases = {"Tired of being a bottom? Get StayMad.lua and become a top!", "hoes mad as always", "Pwned by nn", "Tired of being an nn? Get StayMad.lua! You will still be an nn but cooler."}
